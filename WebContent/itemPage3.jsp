					...
					<div class="contents text-left">
						<div class="row contact-form-area wow fadeInUp"
							...
							<div class="col-md-6 col-lg-6 col-sm-12">
								<img src="home/assets/img/item/6.jpg" style="float: right; width:50%; height:50%"/>
								<h2>
									Product Name : <input type="text" name="productName"
										value="Insta pot" style="font-weight: normal" readonly>
								</h2>
								<h2>
									Category <input type="text" name="category" value="Electronic"
								...
								<h2>
									Tags <input type="text" name="tags" value="electronic electric cooker"
										style="font-weight: normal" readonly>
								</h2>
								<h2>
								...
								<h2>
									Price <input type="text" name="price" value="$25"
										style="font-weight: normal" readonly>
								</h2>
								<h2>
									Negotiable? <input type="text" name="negotiable" value="No"
										style="font-weight: normal" readonly>
								</h2>
								<h2>
									Comments
									<textarea rows="4" cols="50" name="comments"
										style="font-weight: normal" readonly>Used insta pot in good condition. </textarea>
								</h2>
