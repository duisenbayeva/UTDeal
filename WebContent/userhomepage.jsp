...
<%
	...
	List<Item> allItems = (List<Item>)request.getServletContext().getAttribute("allItems");
...
<div class="container">
	...
	<div class="collapse navbar-collapse" id="navbarNav">
		<ul class="nav navbar-nav mr-auto">
			<li class="nav-item"><a class="nav-link" href="#hero-area">
					Home </a></li>
		...
		<ul class="nav navbar-nav ml-auto">
			...
			<li class=" nav-item "><a class="nav-link" href="postItem.jsp">
					Post New Item </a></li>
			<li class="nav-item"><a id="viewPostedItemsLink"
				class="nav-link " href="list_items.jsp"> View Posted Items </a>
...
<ul class="mobile-menu navbar-nav">
	...
	<li><a class="page-scroll" href="postItem.jsp"> Post New Item
	</a></li>
	<li><a class="page-scroll" href="list_items.jsp"> View Posted
			Items </a></li>
							...
							<form action="ItemController" method="post"
								...
								<div>
									<select style="height: 30px" id="categ">
										...
										value="${searchQuery}" autocomplete="off"> <input
										type="submit" name="submit" value="searchItem">Search</input>
												...
												<div class="row contact-form-area wow fadeInUp"
													...
													<form action="ItemController" method="post" id="myform"
														...
														<input type="hidden" name="itemId"
															value="<%=items.get(i).getId()%>" autocomplete="off">
														<input type="hidden" name="submitType"
															value="getItemDetails" autocomplete="off">
						...
						<div class="team-img">
							...
							<div class="team-overlay">
								<div class="overlay-social-icon text-center">
									<ul class="social-icons">
										<li><a
											href="https://www.linkedin.com/in/pavithraconnect/"><i
												class="lni-linkedin-filled" aria-hidden="true"></i></a></li>
									</ul>
								</div>
							</div>
