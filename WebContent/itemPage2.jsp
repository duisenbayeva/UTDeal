					...
					<div class="contents text-left">
						<div class="row contact-form-area wow fadeInUp"
							...
							<div class="col-md-6 col-lg-6 col-sm-12">
								<img src="home/assets/img/item/2.jpg" style="float: right; width:50%; height:50%"/>
								<h2>
									Product Name : <input type="text" name="productName"
										value="Rolling Chair" style="font-weight: normal" readonly>
								</h2>
								<h2>
								...
								<h2>
									Tags <input type="text" name="tags" value="chair rolling new"
										style="font-weight: normal" readonly>
								</h2>
								<h2>
									Is this for sale? <input type="text" name="SaleorRent"
										value="no" style="font-weight: normal" readonly>
								</h2>
								<h2>
									Price <input type="text" name="price" value="$15"
										style="font-weight: normal" readonly>
								</h2>
								<h2>
								...
								<h2>
									...
									<textarea rows="4" cols="50" name="comments"
										style="font-weight: normal" readonly>Brand new rolling chair for rent. </textarea>
								</h2>
