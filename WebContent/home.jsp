...
<title>Welcome to UTDeals</title>
    ...
    <!-- Icon -->
    <link rel="stylesheet" type="text/css" href="home/assets/fonts/line-icons.css">
    <!-- Slicknav -->
    <link rel="stylesheet" type="text/css" href="home/assets/css/slicknav.css">
    <!-- Owl carousel -->
    <link rel="stylesheet" type="text/css" href="home/assets/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="home/assets/css/owl.theme.css">
    <!-- Slick Slider -->
    <link rel="stylesheet" type="text/css" href="home/assets/css/slick.css" >
    <link rel="stylesheet" type="text/css" href="home/assets/css/slick-theme.css" >
    <!-- Animate -->
    ...
    <!-- Responsive Style -->
    <link rel="stylesheet" type="text/css" href="home/sassets/css/responsive.css">
</head>
<body>
          ...
          <div class="row">
            <div class="col-md-12 col-sm-12">
              <div class="contents text-center">
                <h2 class="head-title wow fadeInUp">Welcome to<br> UTDeals</h2>
                <div class="header-button wow fadeInUp" data-wow-delay="0.3s">
                  <a href="register.jsp" class="btn btn-common">SignUp now</a> <a href="login.jsp" class="btn btn-common">SignIn</a>
                </div>
              </div>
        ...
        <div class="row">
          <div class="col-sm-6 col-md-6 col-lg-4">
            ...
            <div class="team-item text-center">
              <div class="team-img">
                <img class="img-fluid" src="home/assets/img/team/team-01.jpg" alt="">
      ...
      <div class="container">
        <div class="row justify-content-md-center">
          <div class="col-md-10 col-lg-5">
            ...
            <p class="wow fadeInUp" data-wow-delay="0.6s">Buy and sell Products <br> </p>
            <form for="">
              <div class="subscribe wow fadeInDown" data-wow-delay="0.3s">
                <input type="Email" class="form-control" name="username" placeholder="enter your netid">
                <a href="register.jsp"><i class="lni-arrow-right"></i></button></a>
              </div>
            </form>
          </div>
        </div>
