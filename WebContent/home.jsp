	...
	<div class="container">
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="#about_Us">
						About Us </a></li>
				<li class="nav-item"><a class="nav-link" href="#team"> Our
						Team </a></li>
				...
				<div class="col-md-12 col-sm-12">
					<div class="contents text-center">
						...
						<div class="header-button wow fadeInUp" data-wow-delay="0.3s">
							<a id="signUpBtn" href="register.jsp" class="btn btn-common"
								style="border-radius: 12px">SignUp now</a> &nbsp <a
								id="signInBtn" href="login.jsp" class="btn btn-common"
								style="border-radius: 12px">SignIn</a>
						</div>
						...
						<div class="right">
							...
							<div class="w3-content w3-section" style="max-width: 500px">
								<img class="mySlides" src="home/assets/img/item/1.jpg"
									...
									class="mySlides" src="home/assets/img/item/2.jpg"
									style="width: 500px; height: 500px"> <img
									class="mySlides" src="home/assets/img/item/3.jpg"
									style="width: 500px; height: 500px"> <img
									class="mySlides" src="home/assets/img/item/5.jpg"
									style="width: 500px; height: 500px"> <img
		...
		<div class="row">
			<div class="col-12">
				<div class="section-header text-center">
					<h2 class="section-title wow fadeInDown" data-wow-delay="0.3s">Learn
						More About us</h2>
				</div>
			</div>
		</div>
				...
				<div class="col-md-6 col-sm-6">
					<div class="features-box wow fadeInLeft" data-wow-delay="0.3s">
						...
						<div class="features-content">
							<h4>Sell and Buy</h4>
							<p>Students can easily sell and buy the products at a cheap
								price.</p>
						</div>
					</div>
				</div>
